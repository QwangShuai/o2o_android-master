...
public class TInfoTaskBean implements Serializable{
    ...
    private List<TInfoWorkerBean> tInfoWorkerBeanList;
    ...
    public List<TInfoWorkerBean> gettInfoWorkerBeanList() {
        return tInfoWorkerBeanList;
    }

    public void settInfoWorkerBeanList(List<TInfoWorkerBean> tInfoWorkerBeanList) {
        this.tInfoWorkerBeanList = tInfoWorkerBeanList;
    }
    ...
    public String toString() {
        return "TInfoTaskBean{" +
                ...
                ", u_start='" + u_start + '\'' +
                ", u_credit='" + u_credit + '\'' +
                ", u_jobs_num='" + u_jobs_num + '\'' +
                ", u_recommend='" + u_recommend + '\'' +
                ", u_worked_num='" + u_worked_num + '\'' +
                ", u_high_opinions='" + u_high_opinions + '\'' +
                ", u_low_opinions='" + u_low_opinions + '\'' +
                ", u_middle_opinions='" + u_middle_opinions + '\'' +
                ...
                ", t_desc='" + t_desc + '\'' +
                ", tInfoWorkerBeanList=" + tInfoWorkerBeanList +
                '}';
    }
}
